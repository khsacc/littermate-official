...
// 遠回りなようだが、fill: currentColorを使えるようにしつつ、classNameやstyleをあてがうこともできるような再利用可能Logo componentを作る

export const LogoMax: NextPage<{ className?: string; style?: CSSProperties }> =
  ({ className, style }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 96.13 77.37"
      className={className}
      style={style}
    >
      <defs>
...
export const LogoMin: NextPage<{ className?: string; style?: CSSProperties }> =
  ({ className, style }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 96.13 68.87"
      className={className}
      style={style}
    >
      <defs>
...
export type LogoSizeProp = "max" | "middle" | "min";

export const LittermateLogo: NextPage<{
  size?: LogoSizeProp;
  className?: string;
  style?: CSSProperties;
}> = ({ size = "max", className, style }) => {
  return (
    <>
      {(() => {
        switch (size) {
          case "middle":
            return <LogoMiddle className={className} style={style} />;
          case "min":
            return <LogoMin className={className} style={style} />;
          default:
            return <LogoMax className={className} style={style} />;
        }
      })()}
    </>
  );
